<?php echo form_open(get_uri("hosting_manager/database/save"), array("id" => "hosting_manager-form", "class" => "general-form", "role" => "form")); ?>
    <div class="modal-body clearfix">
        <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class=" col-md-9">
                        ...
                        echo form_input(array(
                            "id" => "access_url",
                            "name" => "database_name",
                            "value" => $modal_info->database_name ??  "",
                            "class" => "form-control",
                ...
                <div class="row">
                    ...
                    <div class=" col-md-9">
                        ...
                        echo form_input(array(
                            ...
                            "value" =>  $modal_info->database_username ??  "",
                            "class" => "form-control",
                            "placeholder" => app_lang('hosting_manager_database_username'),
                            "autocomplete" => "off"
                        ));
                        ?>
                    </div>
            ...
            <div class="form-group">
                <div class="row">
                    <label for="database_password" class=" col-md-3"><?php echo app_lang('hosting_manager_database_password'); ?></label>
                    <div class=" col-md-9">
                        <div class="input-group">
                            <?php
                                echo form_password(array(
                                    ...
                                    "value" => $modal_info->database_password ??  "",
                                    "class" => "form-control",
